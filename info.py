...
PICS = (environ.get('PICS', 'https://i.postimg.cc/FR0sXrBv/IMG-20251025-235955-748.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://i.postimg.cc/FR0sXrBv/IMG-20251025-235955-748.jpg")
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://i.postimg.cc/7h2xnxgk/IMG-20251026-015225-173.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_Bkash_ID', '01875312198')    # Owner UPI ID for payments
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/HowToDownloadeMovies")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/HowToDownloadeMovies")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/HowToDownloadeMovies")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "akashdeveloper") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "urlbotsot.vercel.app") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "akashdeveloper")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "urlbotsot.vercel.app") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "akashdeveloper")  
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "urlbotsot.vercel.app") # Shortener website for third website
...
LANGUAGES = {"ᴍᴀʟᴀʏᴀʟᴀᴍ":"mal","Bengali":"ben","Bangla":"ban","ᴛᴀᴍɪʟ":"tam","ᴇɴɢʟɪsʜ":"eng","ʜɪɴᴅɪ":"hin","ᴛᴇʟᴜɢᴜ":"tel","ᴋᴀɴɴᴀᴅᴀ":"kan","ɢᴜᴊᴀʀᴀᴛɪ":"guj","ᴍᴀʀᴀᴛʜɪ":"mar","ᴘᴜɴᴊᴀʙɪ":"pun"}
